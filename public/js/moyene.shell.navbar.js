...
moyene.shell.navbar = (function () {
    ...
    var
      ...
      configMap = {
        ...
        + '   <div class="moyene-notification-container moyene-scrollbar">'
        + '   </div>'
        + '     <a href="javascript:void(0)" class="moyene-notification-footer dropdown-header  btn btn-block  text-center">Nenhuma mensagem</a>'
